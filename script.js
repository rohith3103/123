...
const animateElements = document.querySelectorAll(
    '.about-content, .stat-item, .skill-category, .timeline-item, .project-card, .contact-content'
);
...
console.log('%c🚀 Built with vanilla JavaScript, HTML, and CSS', 'font-size: 12px; color: #4a5568;');
